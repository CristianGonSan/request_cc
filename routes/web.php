...
Route::middleware(['auth'])->group(function () {
    ...
    Route::middleware(AdminMiddleware::class)->group(function () {
        ...
        Route::get('/requests/report', [UserRequestController::class, 'report'])->name('requests.report');
        ...
        Route::get('/users/create', [UserController::class, 'showRegistrationForm'])->name('users.create');
